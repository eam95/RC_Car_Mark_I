...
Figure~\ref{fig:NoCalibrationTest} and ~\ref{fig:CalibrationTest} shows the accelerometer waveforms for about 4s, where the RC Car is stationary. This shows how much the velocity calculation has become more precise when calibrated since the gravitional component was removed, although it shows the velocity on the x component slowly increasing but within the mm/s speed range.

	
	
	\begin{figure*}[t]
		\centering
		\includegraphics[width=0.85\textwidth]{docs/images/picturesGeneral/RC_Car_VidTestGUI.png}
	...
	\begin{figure*}[t]
		\centering
		\includegraphics[width=0.85\textwidth]{docs/images/picturesGeneral/RC_Car_VidTestGUI_VelocityZoomed.png}
	...
	\end{figure*}
		...
		\begin{figure*}[t]
		\centering
		\includegraphics[width=0.85\textwidth]{docs/images/picturesGeneral/NoCalibrationWF.png}
	...
	\end{figure*}
			...
			\begin{figure*}[t]
		\centering
		\includegraphics[width=0.85\textwidth]{docs/images/picturesGeneral/CalibrationWF.png}
