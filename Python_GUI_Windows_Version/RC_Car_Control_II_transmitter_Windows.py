...
from RC_CarMainWindowWidgets_Windows import MainWindowWidgetSetup
...
class MainWindow(QMainWindow):
    ...
    def on_data_received(self, t, x, ax, ay, az):
        ...
        self.buf_pwm.append(self._last_pwm_value)
